...
print("\033[0;91mThis Tool's Free By M1L8HA J1H1N")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : M1L8H1 J1H1N'

    print '\033[0;94mFACEBOOK : Maliha Jahan'

    print '\033[0;96mGITHUB   : M1L8H1 J1H1N'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[MALIHA-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[MALIHA-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
